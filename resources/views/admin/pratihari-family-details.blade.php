                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="father_name"> Father Name</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="father_photo"> Father Photo</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <i class="fa fa-user"></i>
                                    <label class="mother_name"> Mother Name</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <i class="fa fa-camera"></i>
                                    <label class="mother_photo">Mother Photo</label>
                            ...
                            <!-- Marital Status -->
                            <div class="col-md-6 mb-3">
                                <label class="form-label"><i class="fa fa-heart"></i> Marital Status</label>
                            ...
                            <div class="row" id="spouseDetails" style="display: none;">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <i class="fa fa-user"></i>
                                        <label class="spouse_name">Spouse Name</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <i class="fa fa-camera"></i>
                                        <label class="spouse_photo">Spouse Photo</label>
                            ...
                            <!-- Children Section -->
                            <div class="col-12">
                                <h5 class="mt-3"><i class="fas fa-child"></i> Children Details</h5>
